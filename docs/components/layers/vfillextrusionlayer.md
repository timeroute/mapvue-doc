...
`FillExtrusionLayer` component. Need use with `VGeoSource`。
...
Load a `geojson` data with `v-fillextrusion-layer`.
...
for more details you can access to mapbox website, [go to](https://docs.mapbox.com/mapbox-gl-js/style-spec/layers/#fill-extrusion)
